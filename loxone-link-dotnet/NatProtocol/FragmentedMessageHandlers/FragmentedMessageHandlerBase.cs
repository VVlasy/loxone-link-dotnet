...
/// </summary>
public interface IFragmentedMessageHandler
{
    /// <summary>
    ...
    /// </summary>
    Task HandleRequestAsync(FragmentedNatFrame frame);
}

/// <summary>
/// Base class for NAT message handlers
/// </summary>
public abstract class FragmentedMessageHandlerBase : IFragmentedMessageHandler
{
    protected readonly LoxoneLinkNatDevice Device;
    protected readonly ILogger? Logger;

    protected FragmentedMessageHandlerBase(LoxoneLinkNatDevice device, ILogger? logger)
    {
        Device = device;
        Logger = logger;
    }
    ...
    public abstract Task HandleRequestAsync(FragmentedNatFrame frame);
